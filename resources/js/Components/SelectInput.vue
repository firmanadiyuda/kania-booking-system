...
<template>
	<div class="relative m-0 p-0 border-0">
		<select ref="select" :id="id" v-bind="$attrs"
			class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-700 tracking-wide bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
